/*
  ...
  - The values [RINING,END] on the enum `CallStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CallStatus_new" AS ENUM ('CALLING', 'ACTIVE', 'ENDED', 'CANCELLED', 'MISSED', 'DECLINED');
